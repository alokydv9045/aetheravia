...
export default function AdminDashboardPro() {
  ...
  <div className="grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 auto-rows-min w-full max-w-[1600px] mx-auto" aria-label="Extended analytics panels">
      {/* Last 14 days */}
      <section className="card bg-base-100 shadow xl:col-span-2 md:col-span-2" aria-labelledby="last14-heading">
        <div className="card-body p-4 sm:p-6">
          <h2 id="last14-heading" className="card-title text-sm sm:text-base">Last 14 Days</h2>
      ...
      {/* Orders by status */}
      <section className="card bg-base-100 shadow" aria-labelledby="status-heading">
        <div className="card-body p-4 sm:p-6">
          <h2 id="status-heading" className="card-title text-sm sm:text-base">Orders by Status</h2>
      ...
      {/* Top products */}
      <section className="card bg-base-100 shadow" aria-labelledby="top-products-heading">
        <div className="card-body p-4 sm:p-6">
          <h2 id="top-products-heading" className="card-title text-sm sm:text-base">Top Products (30d)</h2>
          <div className="overflow-x-auto mt-2">
            <table className="table table-xs sm:table-sm">
      ...
      {/* Low stock */}
      <section className="card bg-base-100 shadow" aria-labelledby="low-stock-heading">
        <div className="card-body p-4 sm:p-6">
          <h2 id="low-stock-heading" className="card-title text-sm sm:text-base">Low Stock (≤5)</h2>
      ...
      {/* Recent orders */}
      <section className="card bg-base-100 shadow xl:col-span-2 md:col-span-2" aria-labelledby="recent-orders-heading">
        <div className="card-body p-4 sm:p-6">
          <h2 id="recent-orders-heading" className="card-title text-sm sm:text-base">Recent Orders</h2>
      ...
      {/* New users */}
      <section className="card bg-base-100 shadow relative overflow-hidden" aria-labelledby="new-users-heading">
        ...
        <div className="card-body p-4 sm:p-6 relative">
          <h2 id="new-users-heading" className="card-title text-sm sm:text-base">New Users (7d)</h2>
